...
BLEDis bledis; //ble discovery service
BLEHidAdafruit blehid; //ble HID service
...
void setup() 
{
  ...
  // a bunch of stuff to print once the serial connection is made. will print to terminal.
  ...
  // Power levels available for XAIO (NRF52840)
